<nav class="mp-nav">
    ...
    <ul class="list-unstyled my-5">
        ...
        <div class="px-4 my-3 position-relative">
            {{ Form::open(['route' => 'collections.store']) }}
                <div class="mp-form-control">
                    <input type="text" class="mp-input--rounded mp-bg-lightgray" name="collection_name" placeholder="Nova coleção">
                    <button class="mp-button-icon" type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z" /></svg>
                    </button>
                </div>
            {{ Form::close() }}                
        </div>
